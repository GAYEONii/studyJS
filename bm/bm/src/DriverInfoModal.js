            ...
            this.$orderTable.render(orders, item => {
                return `
                    <tr>
                        ...
                        <td>${this.data.places.find(place => place.id === item.placeId).name}</td>
                        <td>${this.data.places.find(place => place.id === item.placeId).position.join(', ')}</td>
                        <td>${item.deliveryPosition.join(', ')}</td>
                        <td>${item.price}</td>
                        <td>${item.deliveredAt ? (item.pickedUpAt ? '배달 완료' : '배달 중') : '배달 예정'}</td>
                    </tr>
                `
            })
